...
//   // Check for 'client' OR 'customer' (case-insensitive)
...
//   // --- LOGIC TO HIDE EMPTY "DETAILS" CARD ---
...
//   // Card will only show if at least ONE value is valid
...
//               {/* General Details Card (Only shows if hasGeneralDetails is true) */}
//               {hasGeneralDetails && (
//                 <Card className="w-full shadow-none border-none bg-gray-50">
//                   <CardHeader className="border-b gap-0">
...
//               {/* Main Applicant (Client or Customer) Details Card */}
//               {mainApplicantData && (
//                 <Card className="w-full shadow-none border-none bg-gray-50">
//                   <CardHeader className="border-b gap-0">
//                     <CardTitle className="capitalize">
//                       {/* Title will be "Client Details" or "Customer Details" based on API */}
...
//                       />
//                       <InfoField label="Email" value={mainApplicantData.email} />
...
//             {/* (Filters out Client/Customer to avoid duplication) */}
//             {hasOtherPolicies && (
//               <TabsContent
//                 value="policy"
//                 className="space-y-4 max-h-[70vh] overflow-y-auto pr-3"
...
//   // 1. General Details (Agent, Branch, Payment info etc.) - Shipping removed
//   const generalDetailsList = [
//     orderSingleData.agent_name,
//     orderSingleData.branch_name,
//     orderSingleData.client_id,
                ...
                <Card className="w-full shadow-none border-none bg-gray-50">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <InfoField label="Email" value={orderSingleData.shipping_email} />
